// Inicializando primer color de fondo en el input colon 
...
const primerColorTitulos= function (event) { 
    ...
    for (let index = 0; index < titulos.length; index++) { t
        itulos [index].style.color=colorSeleccionado; 
    }
};
...
for (let index = 0; index < titulos.length; index++) {
 ...
 const startDOM = () => {
    ...
    // Obteniendo la referencia del boton cambiar color de titulos 79 
